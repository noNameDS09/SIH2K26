...
| Postgres + PostGIS | Cloud Firestore `asia-south1` + Firebase Storage |
| Web-only PWA, no Flutter | Flutter app **and** React PWA. App is the hand demo. |
...
ADR-007 PWA-primary → **app is the demo hand-piece**; web still must implement jobs.  
